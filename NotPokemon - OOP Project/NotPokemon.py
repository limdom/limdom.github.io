...
#### Classes:  ####
from pokemon_player import *
from pokemon_monster import *
...
class NotPokemon:
    ...
    def choose_pokemon():
        ...
        while choices_bool: # Only accept one of the specified
            ...
            if pokemon_choice in ["lightning", "l"]:
                os.system('cls||clear') 
            ...
            elif pokemon_choice == "help" or pokemon_choice == "h":
            ...
            elif pokemon_choice == "quit" or pokemon_choice == "q":
    ...
    def gameplay(player_name, pokemon_choice):
        ...
        wanderer = Player("The Crazed Raider", 
        ...
        light,fire,ice = LightMonster(), FireMonster(), IceMonster()
        ...
        if pokemon_choice in ["lightning", "l"]:
            pokemon1 = LightMonster()
        elif pokemon_choice in ["fire", "f"]:
            pokemon1 = FireMonster()
        elif pokemon_choice in ["ice", "i"]:
            pokemon1 = IceMonster()
